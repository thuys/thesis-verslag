\chapter{Overzicht van gedetailleerde implementatie keuzes}\label{sec:implementatiekeuzes}
...
\begin{table}[htbf]
		...
		\end{tabular} 
	\captionof{table}{Configuratie van de consistentie testen met uitzondering van de locatie voor de logbestanden. }
