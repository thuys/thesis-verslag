...
\setup{title={Consistentie en beschikbaarheidstesten voor gedistribueerde database systemen},
...
\setup{filingcard,
  translatedtitle={Consistency and availability benchmarking for distributed database systems},
  udc=681.3,
